  ...
  return (
    <div className='bg-slate-400 py-20 px-20 grid gap-10 lg:grid-cols-2 xl:grid-cols-3 min-h-screen xl:place-content-center'>
      <div className='bg-white dark:bg-black flex flex-col justify-between sm:bg-red-400 md:bg-teal-500 lg:bg-blue-500 xl:bg-yellow-500 p-6 rounded-3xl shadow-xl'>
        ...
        <div className='mt-5 bg-blue-500 text-white p-3 text-center rounded-xl w-2/4 mx-auto hover:bg-teal-100 hover:text-black
      active:bg-yellow-500 focus:bg-red-500'>Checkout</div>
      </div>

      <div className='bg-white overflow-hidden rounded-3xl shadow-xl group'>
        <div className='bg-blue-500 landscape:bg-teal-400 p-6 pb-14 xl:pb-40'>
      ...
      <div className='bg-white p-6 rounded-lg shadow-xl lg:col-span-2 xl:col-span-1'>
